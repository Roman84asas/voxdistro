...
(function ($) {
    ...
    $("img_voxdistro, a").on("dragstart", function (event) {
    ...
    var mPopup = function () {
        ...
        $('.wp-block-image img_voxdistro,.single-photo-popup,.gallery-item,.kb-content a[href*=".jpg"],.kb-content a[href*=".png"]').on("click", function (e) {
            e.preventDefault();
            var $this = $(this);
    ...
    var config = {
        ...
        onSuccess: function ($form) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (operators.length > 0) {
                            ...
                            $(".cfn-operators p:first-child").text("РўР°РєРѕР№ РЅРѕРјРµСЂ РЅРµ РѕР±СЃР»СѓР¶РёРІР°РµС‚СЃСЏ РЅРё РѕРґРЅРёРј РѕРїРµСЂР°С‚РѕСЂРѕРј.");
                        }
                    ...
                    $.ajax({
                        ...
                        error: function (xhr, str) {
                            ...
                            $.toast({
                                icon: 'error',
                                heading: "РћС€РёР±РєР°!",
                                text: 'Р’РѕР·РЅРёРєР»Р° РѕС€РёР±РєР°: ' + xhr.responseCode,
            ...
            /**
             * Р±Р»РѕРєРёСЂСѓРµРј РґР°Р»СЊРЅРµР№С€СѓСЋ РѕР±СЂР°Р±РѕС‚РєСѓ С„РѕСЂРјС‹ РґР»СЏ СЃРѕСЂС‚РёСЂРѕРІРєРё С‚РѕРІР°СЂР° РІ РјР°РіР°Р·РёРЅРµ
             */
    ...
    $(".second-mnu a").on("mouseover", function (e) {
        ...
        $(".first-img_voxdistro").css("background-image", "url(" + img + ")");
    });
    $(".second-mnu").on("mouseleave", function (e) {
        $(".first-img_voxdistro").css("background-image", "none");
    });
    ...
    $(document).on("click", ".to-compare", function (e) {
        if (!$(this).hasClass("active")) {
            ...
            $(this).addClass("active").find(".to-compare-text").text("Р’ СЃСЂР°РІРЅРµРЅРёРё");
        }
    });
    ...
    $(document).on("click", ".to-bookmark", function (e) {
        if (!$(this).hasClass("active")) {
            ...
            $(this).addClass("active").find(".to-compare-text").text("Р’ Р·Р°РєР»Р°РґРєР°С…");
        }
    });


    //AJAX Р”РѕР±Р°РІР»РµРЅРёРµ РІ РєРѕСЂР·РёРЅСѓ
    $(document).on("click", ".add-to-cart", function (e) {
        ...
        $.ajax({
            ...
            if (data != "") {
                ...
                $this.text("Р’ РєРѕСЂР·РёРЅРµ").attr("href", "/cart/");
            }
    ...
    function lazyload() {
        ...
        $("img_voxdistro[data-src]").each(function () {
